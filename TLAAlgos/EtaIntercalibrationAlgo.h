#ifndef xAODAnaHelpers_EtaIntercalibrationAlgo_H
#define xAODAnaHelpers_EtaIntercalibrationAlgo_H
...
class EtaIntercalibrationAlgo : public TreeAlgo
{

public:

  // this is a standard constructor
  EtaIntercalibrationAlgo (std::string className = "EtaIntercalibrationAlgo");                                           //!
...
//  virtual EL::StatusCode treeFinalize ();                   //!
  ...
  ClassDef(EtaIntercalibrationAlgo, 1);                                 //!
  /// @endcond
