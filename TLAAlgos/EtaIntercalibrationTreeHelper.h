#ifndef AnalysisExample_EtaIntercalibrationTreeHelper_H
#define AnalysisExample_EtaIntercalibrationTreeHelper_H

#include "xAODAnaHelpers/HelpTreeBase.h"
#include "TTree.h"

class EtaIntercalibrationTreeHelper : public HelpTreeBase
{
...
public:
    ...
    EtaIntercalibrationTreeHelper(xAOD::TEvent * event, TTree* tree, TFile* file, const float units, bool debug = false, bool DC14 = false, xAOD::TStore* store = nullptr, bool doJets = true, bool doTriggerJets = false, bool doTruthJets = false);
    ~EtaIntercalibrationTreeHelper();
