...
EtaIntercalibrationTreeHelper :: EtaIntercalibrationTreeHelper(xAOD::TEvent * event, TTree* tree, TFile* file, const float units, bool debug, bool DC14, xAOD::TStore* store, bool doJets, bool doTriggerJets, bool doTruthJets) :
HelpTreeBase(event, tree, file, units, debug, DC14, store)
{
    Info("EtaIntercalibrationTreeHelper", "Creating output TTree");
    m_firstEvent = true;
    m_store = store;
    m_doJets = doJets;
...
EtaIntercalibrationTreeHelper :: ~EtaIntercalibrationTreeHelper()
{
}
//////////////////// Connect Defined variables to branches here /////////////////////////////
void EtaIntercalibrationTreeHelper::AddEventUser(const std::string detailStr)
{
...
void EtaIntercalibrationTreeHelper::AddJetEvent(const std::string jetName) {
...
/*void EtaIntercalibrationTreeHelper::AddJetsUser(const std::string detailStr, const std::string jetName)
{
...
void EtaIntercalibrationTreeHelper::ClearEventUser() {
...
void EtaIntercalibrationTreeHelper::ClearJetEvent(const std::string jetName) {
...
/*void EtaIntercalibrationTreeHelper::ClearJetsUser(const std::string jetName ) {
...
void EtaIntercalibrationTreeHelper::FillEventUser( const xAOD::EventInfo* eventInfo ) {
...
void EtaIntercalibrationTreeHelper::FillJetEvent( const xAOD::EventInfo* eventInfo, const std::string jetName) {
...
//void EtaIntercalibrationTreeHelper::FillJetsUser( const xAOD::Jet* jet, const std::string jetName ) {
...
//void EtaIntercalibrationTreeHelper::AddBtagHighEff() {
//    
...
//void EtaIntercalibrationTreeHelper::AddBtagLowEff() {
//    
...
//void EtaIntercalibrationTreeHelper::FillBtagHighEff( const xAOD::EventInfo* eventInfo ) {
//    
...
//}
//
//void EtaIntercalibrationTreeHelper::FillBtagLowEff( const xAOD::EventInfo* eventInfo ) {
//    
...
//}
//
//void EtaIntercalibrationTreeHelper::ClearBtagHighEff() {
//    
//    m_mbb_fix_7777 = -999;
//    m_mbb_fix_8585 = -999;
//    m_mbb_flt_7777 = -999;
...
//}
//
//void EtaIntercalibrationTreeHelper::ClearBtagLowEff() {
//    
//    m_mbb_fix_6060 = -999;
//    m_mbb_fix_7070 = -999;
//    m_mbb_flt_6060 = -999;
